...
const products = [
    ...
    },
    {
        ...
        description: "Morceau persillé, idéal pour les grillades. Saveur intense et texture parfaite.",
        price: 5000,
        priceUnit: "250g",
        ...
        category: "beef",
        featured: true,
        tags: ["Persillé", "Grillade", "Premium"],
        stock: 20,
        weight: 250
    },
    {
    ...
    },
    {
        ...
        description: "Saucisses 100% bœuf, parfumées aux herbes. Parfaites pour grillades et ragoûts.",
        price: 5000,
        priceUnit: "250g",
        image: "https://maison-godet.fr/wp-content/uploads/Saucisse-de-Boeuf.jpeg",
        unit: "250g",
        category: "beef",
...
class UIManager {
    ...
    async handleCheckout(e) {
        ...
        if (!customerName || !customerEmail || !customerPhone) {
            this.showToast('Veuillez remplir vos coordonnées (nom, email, téléphone)', 'Formulaire incomplet', 'error');
            return;
        }

        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!emailRegex.test(customerEmail)) {
            this.showToast('Veuillez saisir une adresse email valide', 'Email invalide', 'error');
            return;
        }
        ...
        try {
            ...
            this.showToast('Erreur lors de l\'envoi. Contactez-nous sur WhatsApp.', 'Erreur', 'error');
        } finally {
            this.hideLoading();
        }
    }
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🥩 Andy la Boucherie - Site initialisé (Nodemailer)');
    ...
    if (!document.getElementById('contactForm')) {
        // Si nous sommes sur restaurants.html, on initialise le RestaurantUIManager
        if (document.getElementById('restaurantProductsGrid')) {
            // Le gestionnaire RestaurantUIManager est défini dans restaurants.html
            console.log('🍽️ Page restaurants détectée');
        }
        return;
    }
